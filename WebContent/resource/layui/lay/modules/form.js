...
function(e) {
    ...
    var d = function() {//submit提交动作后的操作
        var e = t(this),
        a = f.config.verify,// f = new u,
        s = null,
        o = "layui-form-danger",
        c = {},
        u = e.parents(r),
        ...
        layui.event.call(this, l, "submit(" + y + ")", {//l = "form", d = fn
            elem: this,
            form: v,
            field: c
        })
    ...
    v.on("submit", r, d).on("click", "*[lay-submit]", d),//r = ".layui-form",
    e(l, f)//l = 'from', f = new u,
});