...
function(e) {
    ...
    H = ['<div class="layui-form layui-border-box {{d.VIEW_CLASS}}" lay-filter="LAY-table-{{d.index}}" lay-id="{{ d.data.id }}" style="{{# if(d.data.width){ }}width:{{d.data.width}}px;{{# } }} {{# if(d.data.height){ }}height:{{d.data.height}}px;{{# } }}">', "{{# if(d.data.toolbar){ }}", '<div class="layui-table-tool">', '<div class="layui-table-tool-temp"></div>', '<div class="layui-table-tool-self"></div>', "</div>", "{{# } }}", '<div class="layui-table-box">', "{{# if(d.data.loading){ }}", '<div class="layui-table-init" style="background-color: #fff;">', '<i class="layui-icon layui-icon-loading layui-icon"></i>', "</div>", "{{# } }}", "{{# var left, right; }}", '<div class="layui-table-header">', E(), "</div>", '<div class="layui-table-body layui-table-main">', z, "</div>", "{{# if(left){ }}", '<div class="layui-table-fixed layui-table-fixed-l">', '<div class="layui-table-header">', E({
        fixed: !0
    ...
    j.prototype.render = function() {
        ...
        if (a.index = e.index, n[0] && n.remove(), l.after(o), e.layTool = o.find(m), e.layBox = o.find(g), e.layHeader = o.find(x), e.layMain = o.find(C), e.layBody = o.find(k), e.layFixed = o.find(w), e.layFixLeft = o.find(T), e.layFixRight = o.find(A), e.layTotal = o.find(L), e.layPage = o.find(S), e.renderToolbar(), e.fullSize(), a.cols.length > 1) {
    ...
    j.prototype.reload = function(e, i) {
        var a, l, n = this,
        o = "string" == typeof e;
        a = o ? i: e,
        l = o ? e: i,
        a = a || {},
        a.data && a.data.constructor === Array && delete n.config.data,
        n.config = t.extend(!0, {},
        n.config, a),
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            t.ajax({
                ...
                success: function(t) {
                    ...
                    t[n.statusName] != n.statusCode ? (i.renderForm(), i.layMain.html('<div class="' + p + '">' + (t[n.msgName] || "返回的数据不符合规范，正确的成功状态码 (" + n.statusName + ") 应为：" + n.statusCode) + "</div>")) : (i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"),
                    i.setColsWidth(),
                    "function" == typeof a.done && a.done(t, e, t[n.countName])
                },
                error: function(e, t) {
                    i.layMain.html('<div class="' + p + '">数据接口请求异常：' + t + "</div>"),
                    i.renderForm(),
                    i.setColsWidth()
                }
            })
            ...
            i.renderData(c, e, a.page && a.page.count ? a.page: a.data.length),
            o(),
            i.setColsWidth(),
    ...
    j.prototype.renderData = function(e, n, o, r) {
        var c = this,
        s = c.config,
        h = e[s.response.dataName] || [],
        y = [],
        v = [],
        m = [],
        g = function() {
            var e;
            return ! r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(h,
            function(a, l) {
                var o = [],
                h = [],
                p = [],
                ...
                0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function(n, r) {
                    ...
                    if (void 0 !== v && null !== v || (v = ""), !r.colGroup) {
                        var m = ['<td data-field="' + c + '" data-key="' + y + '" ' +
                        function() {
                            var e = [];
                        ...
                        o.push(m),
                        r.fixed && "right" !== r.fixed && h.push(m),
                        "right" === r.fixed && p.push(m)
                    }
                }), y.push('<tr data-index="' + a + '">' + o.join("") + "</tr>"), v.push('<tr data-index="' + a + '">' + h.join("") + "</tr>"), m.push('<tr data-index="' + a + '">' + p.join("") + "</tr>"))
            }), c.layBody.scrollTop(0), c.layMain.find("." + p).remove(), c.layMain.find("tbody").html(y.join("")), c.layFixLeft.find("tbody").html(v.join("")), c.layFixRight.find("tbody").html(m.join("")), c.renderForm(), "number" == typeof e && c.setThisRowChecked(e), c.syncCheckAll(), c.haveInit ? c.scrollPatch() : setTimeout(function() {
                c.scrollPatch()
            },
        ...
        d.cache[c.key] = h,
        c.layPage[0 == o || 0 === h.length && 1 == n ? "addClass": "removeClass"](f),
        r ? g() : 0 === h.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + p).remove(), c.layMain.append('<div class="' + p + '">' + s.text.none + "</div>")) : (g(), c.renderTotal(h), void(s.page && (s.page = t.extend({
    ...
    j.prototype.sort = function(e, i, a, l) {
        ...
        try {
            ...
            var v = c.layHeader.find("th .laytable-cell-" + p).find(N);
            c.layHeader.find("th").find(N).removeAttr("lay-sort"),
    ...
    j.prototype.events = function() {
        ...
        function(e) {
            ...
            layui.event.call(this, h, "toolbar(" + p + ")", t.extend({
                event: c,
                config: o
            },
            {}))
        ...
        function() {
            ...
            layui.event.call(e[0], h, "checkbox(" + p + ")", v.call(e[0], {
                checked: n,
                type: o ? "all": "one"
            }))
        }),
        ...
        function() {
            ...
            layui.event.call(this, h, "radio(" + p + ")", v.call(this, {
                checked: i
            }))
        }),
        ...
        function() {
            var e = t(this),
            i = e.index();
            a.layBody.find("tr:eq(" + i + ")").addClass(_)
        }).on("mouseleave", "tr",
        function() {
            var e = t(this),
            i = e.index();
            a.layBody.find("tr:eq(" + i + ")").removeClass(_)
        }).on("click", "tr",
        function() {
            m.call(this, "row")
        }).on("dblclick", "tr",
        ...
        var m = function(e) {
            var i = t(this);
            layui.event.call(this, h, e + "(" + p + ")", v.call(i.children("td")[0]))
        };
        ...
        function() {
            ...
            o = d.cache[a.key][n];
            o[l] = i,
            layui.event.call(this, h, "edit(" + p + ")", v.call(this, {
                value: i,
                field: l
            }))
        }).on("blur", "." + W,
        ...
        function() {
            ...
            layui.event.call(this, h, "tool(" + p + ")", v.call(this, {
    ...
    d.init = function(e, i) {
        i = i || {};
        var a = this,
        l = t(e ? 'table[lay-filter="' + e + '"]': y + "[lay-data]"),
