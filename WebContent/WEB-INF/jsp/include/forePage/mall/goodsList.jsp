...
<!-- start goods list -->
	<div class="layui-container " style="overflow: hidden; margin-top: 30px;">
        ...
        <div class="layui-col-md3">
          <div class="grid-demo grid-demo-bg1 pointer" lay-href="<%=basePath%>mall_chtml_goodsdetails?id=123456" style="height: 300px; border:1px solid #dddddd73;">
        ...
        <div class="layui-col-md3">
          <div class="grid-demo pointer" lay-href="<%=basePath%>mall_chtml_goodsdetails?id=123456" style="height: 300px; border:1px solid #dddddd73;">	
        ...
        <div class="layui-col-md3">
          <div class="grid-demo grid-demo-bg1 pointer" lay-href="<%=basePath%>mall_chtml_goodsdetails?id=123456" lay-href="<%=basePath%>mall_chtml_goodsdetails?id=123456" style="height: 300px; border:1px solid #dddddd73;">
