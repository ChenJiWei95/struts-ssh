...
<html>
 <head>
  ...
  <title><s:text name="shop.common.coupon"/></title> 
 ...
 <body>
	...
	<div class="cnt">
		...
		<div class="layui-container" style="height: 30px;">
			<span class="layui-breadcrumb" lay-separator=">" style="line-height: 30px;">
			  ...
			  <a href="javascript:void(0)" class="var-color"><s:text name="shop.common.coupon"/></a>
			</span>
		</div>
		<div class="layui-container" style="margin-top: 20px; ">
			...
			<%@ include file="../../include/forePage/ucenter/couponCon.jsp" %>
		</div>
	</div>
	...
	<script>
 	layui.use(['layer', 'element'], function(){
 		...
 		layui.$(".coupon").eq(0).addClass("var-color");
 	})
	</script>
 </body>
</html>