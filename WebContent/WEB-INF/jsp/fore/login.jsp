...
<html>
  ...
  <body style="height: 100%;" >
  	<a href="<%=basePath%>fore_main_login?request_locale=zh_CN"><s:text name="shop.common.chinese"/></a>
    <a href="<%=basePath%>fore_main_login?request_locale=en_US"><s:text name="shop.common.english"/></a>
	<!-- start mall nav -->
