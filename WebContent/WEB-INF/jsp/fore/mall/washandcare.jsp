...
<html>
 <head>
  ...
  <title><s:text name="shop.common.nav4"/></title> 
 ...
 <body>
	...
	<div class="layui-container" style=" ">
		<span class="layui-breadcrumb" lay-separator=">" style="line-height: 55px;">
		  <a href="<%=basePath%>fore_main_index"><s:text name="shop.common.nav4"/></a>
		  <a href="javascript:void(0)" class="var-color"><s:text name="shop.common.nav4"/></a>
		</span>
	</div>
